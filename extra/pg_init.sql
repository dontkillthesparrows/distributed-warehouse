...
INSERT INTO 
   stores
   (storeaccount, chain_name, chain_id, store_id)
VALUES
   ('test_store_1', 'acme_hq', '30', '100'),
   ('test_store_2', 'acme_industries', '10', '604'),
   ('test_store_3', 'acme_industries', '10', '607'),
   ('test_store_4', 'acme_industries', '10', '609'),
   ('test_store_5', 'acme_boutique', '40', '105'),
   ('test_store_6', 'acme_boutique', '40', '106'),
   ('test_store_7', 'acme_boutique', '40', '117');
