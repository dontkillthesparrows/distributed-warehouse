...
import { Grid, Title, BigButtonContainer, Svg, Text, Back, HR } from './Style';
import {
        ...
        <>
          <Grid>
            ...
            <BigButtonContainer>
              ...
              <MultipleChoiceBtn
                onClick={() => handleDeclinedReason('Har ikke tid')}
              >
                Har ikke tid
              </MultipleChoiceBtn>
              <MultipleChoiceBtn onClick={() => handleDeclinedReason('Annet')}>
                Annet
              </MultipleChoiceBtn>
            </BigButtonContainer>
          </Grid>
